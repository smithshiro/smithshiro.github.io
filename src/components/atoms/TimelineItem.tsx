...
const TimelineItem: React.FC<Props> = (data: Props) => {
  ...
  return (
    <li className="mb-10 ms-6">            
        <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 dark:bg-blue-900 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900">
        ...
        <div className="my-2">
          <p className="border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">Tasks</p>
        ...
        <div className="my-2">
          <p className="border-b border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white">Skill Set</p>
