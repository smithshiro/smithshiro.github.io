  ...
  return (
    <li className="mb-10 ms-6">            
        ...
        <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900">
          ...
          {
            isLatest ? (
              <span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded ms-3">Latest</span>
            ) : null
          }
        </h3>
        <time className="block mb-2 text-sm font-normal leading-none text-gray-400">{time}</time>
        <div className="my-2">
          <p className="border-b border-gray-200 text-gray-900">Tasks</p>
        ...
        <div className="my-2">
          <p className="border-b border-gray-200 text-gray-900">Skill Set</p>
          <ul className="flex flex-wrap gap-x-2 text-sm text-gray-600">
            {
